...
function init() {
    ...
    new RGBELoader().setDataType(THREE.UnsignedByteType)
        .setPath('./assets/textures/equirectangular/').load('quarry_01_1k.hdr', function (texture) {
...
function initGarage() {
    ...
    loader.load('./assets/models/gltf/garage_done.glb', function (gltf) {
        var garage =
            gltf.scene;
...
function initCar() {
    ...
    loader.setDRACOLoader(dracoLoader);
    loader.load('./assets/models/gltf/car.glb', function (gltf) {
        ...
        // shadow 
        var texture =
            new THREE.TextureLoader().load('./assets/models/gltf/ferrari_ao.png');
        ...
        //transparency model 
        var texture = new THREE.TextureLoader().load('./assets/textures/carcar_done.png');
...
function playBackgroundMusic() {
    ...
    audioLoader.load('./assets/sounds/Point_Green_Getdown.mp3', function (buffer) {
...
function initLightCar() {
    ...
    var texture = textureLoader.load('./assets/textures/flareHead.jpg');
    uniforms = {
